function formifyInit(fields, url, heading = 'Contact/Feedback') {
  ...
  const formNoticeWarningCSS = `
    ${formNoticeCSS}
    color: rgb(232, 232, 64);
    display: block;
  `;
  const formNoticeSuccessCSS = `
    ${formNoticeCSS}
    color: #22d3ee;
    display: block;
  `;
  ...
  <svg version="1.1" id="L4" xmlns="http://www.w3.org/2000/svg"   xmlns:xlink="http://www.w3.org/1999/xlink"
    x="0px" y="0px" viewBox="0 10 50 80" enable-background="new 0 0 0 0" xml:space="preserve" width="80"
    height="80">
  ...
  formToggler.innerHTML = `
  <svg xmlns='http://www.w3.org/2000/svg' className='h-5 w-5 text-gray-50' style="color: #eee;" fill='none'
  viewBox='0 0 24 24' stroke='currentColor' strokeWidth={2} width="28" height="28">
  <path strokeLinecap='round' strokeLinejoin='round'
    d='M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z' />
  </svg>
  `;

  formToggler.style.cssText = `
    width: 32px;
    height: 32px;
    border-radius: 100%;
    background-color: #374151;
